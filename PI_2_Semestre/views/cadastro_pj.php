<?php
$titulo = "Cadastro Pessoa Jurídica - Singularys";
$descricao = "Cadastro de titular pessoa jurídica Singularys.";
$layoutArea = "app";
            ...
            <div class="<?php echo $colFormulario; ?>">
                <div class="app-card p-4 p-md-5">
                    <div class="d-flex flex-wrap justify-content-between align-items-start gap-2 mb-4">
                        <div>
                            <p class="text-uppercase text-muted small mb-1">Pessoa Jurídica</p>
                            <h1 class="h3 app-page-title fw-bold mb-0">Dados da empresa</h1>
                        </div>
                    ...
                    <form action="index.php?controle=clienteController&metodo=cadastrar" method="post" novalidate>
                        ...
                        <fieldset class="border rounded-3 p-3 mb-4">
                            <legend class="float-none w-auto px-2 fs-6 fw-semibold mb-0">Empresa</legend>
                            <div class="row g-3 mt-1">
                                <div class="col-md-6">
                                    <label class="form-label" for="razao_social">Razão social</label>
                                    <input class="form-control" id="razao_social" name="razao_social" required
                                           value="<?php echo htmlspecialchars($dados["razao_social"] ?? ""); ?>">
                                    <small class="text-danger mvc-error"><?php echo htmlspecialchars($msg["razao_social"] ?? ""); ?></small>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-danger mvc-error"><?php echo htmlspecialchars($msg["cnpj"] ?? ""); ?></small>
                                </div>
                            </div>
                        </fieldset>

                        <fieldset class="border rounded-3 p-3 mb-4">
                            <legend class="float-none w-auto px-2 fs-6 fw-semibold mb-0">Representante legal</legend>
                            <div class="row g-3 mt-1">
                                <div class="col-md-6">
                                    <label class="form-label" for="representante_nome">Nome completo</label>
                                    <input class="form-control" id="representante_nome" name="representante_nome" required
                                           value="<?php echo htmlspecialchars($dados["representante_nome"] ?? ""); ?>">
                                    <small class="text-danger mvc-error"><?php echo htmlspecialchars($msg["representante_nome"] ?? ""); ?></small>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="representante_cpf">CPF</label>
                                    <input class="form-control" id="representante_cpf" name="representante_cpf" required
                                           value="<?php echo htmlspecialchars($dados["representante_cpf"] ?? ""); ?>">
                                    <small class="text-danger mvc-error"><?php echo htmlspecialchars($msg["representante_cpf"] ?? ""); ?></small>
                                </div>
                            </div>
                        </fieldset>
